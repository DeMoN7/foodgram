...
class Tag(models.Model):
    ...
    color = models.CharField(
        ...
        validators=[recipe_validators.HexColorValidator()]
    )
    slug = models.SlugField(
        verbose_name='Ссылка',
        unique=True,
        validators=[recipe_validators.TagSlugValidator()]
    )
    ...
    cooking_time = models.IntegerField(
        ...
        validators=[
            ...
            validators.MaxValueValidator(
                1440, message='Время приготовления должно быть больше суток!'
            )
        ]
    )
