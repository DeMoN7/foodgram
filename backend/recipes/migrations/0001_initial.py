# Generated by Django 3.2.3 on 2023-07-19 12:19

from django.conf import settings
import django.core.validators
from django.db import migrations, models
import django.db.models.deletion
import recipes.recipe_validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=7, unique=True, validators=[recipes.recipe_validators.HexColorValidator()], verbose_name='Цвет')),
                ('slug', models.SlugField(unique=True, validators=[recipes.recipe_validators.TagSlugValidator()], verbose_name='Ссылка')),
            ],
            options={
                'verbose_name': 'Тег',
